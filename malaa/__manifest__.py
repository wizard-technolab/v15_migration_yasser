...
{
    'name': "Malaa Integration",  # The name of the module
    'version': '15.0.1',  # The version of the module
    'summary': """Malaa Integration""",  # A brief summary of the module's purpose
    'description': """A module to Integrat between Fuel Finance and Malaa""",  # A detailed description of the module
    ...
    'depends': ['base','loan'],  # The list of other modules that this module depends on
    # always loaded
    'data': [
