...
{
    'name': "Fuel Finance Integration",  # The name of the module
    'version': '15.0.1',  # The version of the module
    'summary': """Main Fuel Finance API""",  # A brief summary of the module's purpose
    'description': """A module to connect all external service providers with the Loan module""",  # A detailed description of the module
