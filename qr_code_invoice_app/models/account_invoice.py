...
class QRCodeInvoice(models.Model):
    ...
    partner_vat = fields.Char(string='Partner Tax ID', help="The Parnter Tax Identification Number.",
                              related='partner_id.vat', store=True)
    company_vat = fields.Char(string='Company Tax ID', related="company_id.vat", store=True, index=True,
    ...
    # loan_seq = fields.Many2one("loan.order", required=True, readonly=True)
    # sequence = fields.Char(string='Sequence', related='loan_seq.seq_num', store=True)
